...
const NewGroupModal = ({ setModalOpen }) => {
  ...
  const createGroup = async () => {
    ...
    formdata.append(
      "participants",
      JSON.stringify(selectedContacts.map((contact) => contact.contact._id))
    );
  ...
  return (
    ...
    >
      <div className=" p-3 flex flex-col h-140  overflow-y-scroll custom-scrollbar w-84 shadow-lg rounded-md left-0">
        ...
        <div
          className={`flex items-center border-b-1 p-2 min-h-[40px] overflow-y-auto
          ...
          {selectedContacts.length === 0 ? (
            ...
            selectedContacts.map((contact) => (
              <div
                ...
                className="flex flex-nowrap items-center space-x-2 bg-green-600 px-2 py-1 rounded-lg mr-2"
              >
                <img
                  ...
                  <p>
                    <input
                      ...
                      checked={selectedContacts.some(
                        (c) => c.contact.Phone === contact.contact.Phone
                      )}
          ...
          <div className="flex flex-col h-full space-x-2 justify-between text-sm">
            <div className="mt-4 flex space-x-4 items-center">
              ...
              <button
                ...
                className="cursor-pointer bg-gray-500 p-3 rounded-full"
              >
                <Camera size={24} />
              </button>

              <p>
                Add group icon <span className="text-gray">(optional)</span>
              </p>
            ...
            <div className="mt-4">
              ...
              <select
                name=""
                id=""
                className="bg-gray-600 outline-0 p-2 rounded-sm text-sm pr-2"
            ...
            <p className="flex-1 mt-4">
              All new messages in this chat will disappear
              <br />
