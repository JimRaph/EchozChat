  ...
  return (
    <div className="">
      ...
      <div className="flex justify-between items-center">
        <p>Start EchozChat at login</p>
        {toggleLogin === "off" ? (
          <span
            className="flex space-x-2 items-center"
            onClick={() => setToggleLogin("on")}
          >
      ...
      <div className="mt-2">
        <span
          ...
          rounded-md cursor-pointer ${
            theme ? "border border-[#FFFFFF]" : "bg-gray-700"
          }`}
        >
          <GlobeIcon size={18} />
          <p className="whitespace-nowrap overflow-x-hidden">
            {selectedLang.english} {selectedLang.local}
          </p>
      ...
      <div className="flex flex-col mt-6 ">
        ...
        <p className="text-xs">
          Changed typing settings for autocorrect and misspelled highlight from{" "}
        ...
        <div className="mt-4">
          ...
          <p className="text-xs text-green-600 underline mt-1">
            See list of text
          </p>
        </div>
      </div>
      ...
      <div className="text-xs w-[90%] mt-6 pb-10">
        To <span className="font-semibold">log out</span> of EchozChat on this
        computer go your{" "}
        <span className="text-green-600 underline">Profile.</span>
      </div>
    </div>
  );
};
